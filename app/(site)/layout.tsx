export default function SiteLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      {/* Top bar */}
      <div className="site-topbar" style={{ background: 'var(--navy-dark)', borderBottom: '1px solid #1e3a5f' }}>
      ...
      <header style={{ background: 'var(--navy)', borderBottom: '3px solid var(--gold)' }}>
        <div className="site-header-inner" style={{ maxWidth: 1100, margin: '0 auto', padding: '20px 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <nav className="site-nav" style={{ display: 'flex', gap: 32 }}>
            {[
              { href: '/', label: 'Roles' },
      ...
      <main className="site-main" style={{ maxWidth: 1100, margin: '0 auto', padding: '40px 24px', minHeight: '70vh' }}>
        {children}
      </main>

      <footer style={{ background: 'var(--navy)', borderTop: '3px solid var(--gold)', marginTop: 80 }}>
        <div className="site-footer-inner" style={{ maxWidth: 1100, margin: '0 auto', padding: '32px 24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
